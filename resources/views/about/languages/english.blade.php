...
<body>
    <div class="container">
        <h1>Learn English</h1>
        <p>English is the most widely spoken language in the world. Our course will help you learn basic to advanced English in no time!</p>
        ...
        <a href="/register" class="btn">Register for English Course</a>
