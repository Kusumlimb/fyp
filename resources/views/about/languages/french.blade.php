...
<body>
    <div class="container">
        <h1>Learn French</h1>
        <p>French is one of the most widely spoken languages in the world. Our course will help you learn basic to advanced Spanish in no time!</p>

        <h2>Course Details</h2>
        <ul>
            <li>French Vocabulary</li>
        ...
        <a href="/register" class="btn">Register for French Course</a>
