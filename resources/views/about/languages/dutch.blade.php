...
<body>
    <div class="container">
        <h1>Learn Dutch</h1>
        <p>Dutch is one of the most widely spoken languages in the world. Our course will help you learn basic to advanced Spanish in no time!</p>

        <h2>Course Details</h2>
        <ul>
            <li>Dutch Vocabulary</li>
        ...
        <a href="/register" class="btn">Register for Dutch Course</a>
