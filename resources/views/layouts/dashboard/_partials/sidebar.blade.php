...
<div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
        <a class="flex h-16 shrink-0 items-center" href="{{route('front.home')}}">
            <img class="h-full w-auto" src="{{Vite::asset('resources/images/logo.png')}}" alt="Logo">
        </a>
                    ...
                    <ul role="list" class="-mx-2 space-y-1">
                        ...
                        <li>
                            <a href="{{route('dashboard.quiz.index')}}"
                                    @class([
                                        'group flex gap-x-3  rounded-md p-2 text-sm/6 font-semibold text-gray-400 hover:text-white hover:bg-gray-800',
                                        'bg-gray-800 text-white' => $activeMenu === 'quiz'
                                    ])
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
