    ...
    <div class="relative z-50 lg:hidden"
        ...
        <div class="fixed inset-0 flex">
            <div
                ...
                @include('layouts.dashboard._partials.sidebar1')
            </div>
        </div>
    </div>
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            <span class="hidden lg:flex lg:items-center">
                                <span class="flex items-center justify-center rounded-full size-8 text-white text-sm/6 bg-gray-900 font-bold">{{getInitials(auth()->user()->name)}}</span>
