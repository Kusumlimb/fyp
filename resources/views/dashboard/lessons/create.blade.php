...
<div class="container">
    ...
    <form enctype="multipart/form-data" method="POST" action="{{ route('dashboard.lessons.store') }}" class="w-1/2 mx-auto">
        @if ($errors->any())
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <p class="mt-1 text-sm/6 text-gray-600">Provide details about the lesson you want to create.</p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <p class="mt-3 text-sm/6 text-gray-600">Provide a detailed description of the lesson of your course.</p>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <p class="mt-3 text-sm/6 text-gray-600">Upload a video file for the lesson. Accepted formats: mov, mp4, avi, mkv, etc.</p>
                    </div>
