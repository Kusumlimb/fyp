...
<div class="container mx-auto mt-10 max-w-4xl">
    <h2 class="text-2xl font-semibold mb-4">Courses Management</h2>
            ...
            <tbody>
                @foreach($courses as $course)
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <form action="{{ route('admin.deleteCourse', $course->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                @csrf
                                @method('DELETE')
